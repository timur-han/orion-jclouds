...
public class ClearFilesInContainer implements ClearContainerStrategy {
	...
	@Inject
	public ClearFilesInContainer(@Provider Supplier<Credentials> creds,
			OrionApi api) {
	...
	public void execute(String containerName) {
		List<OrionChildMetadata> children = this.api.listContainerContents(
				getUserWorkspace(), containerName);
