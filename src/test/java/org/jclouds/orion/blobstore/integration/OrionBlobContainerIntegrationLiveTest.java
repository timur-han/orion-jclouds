...
@Test(groups = "live")
public class OrionBlobContainerIntegrationLiveTest extends BaseContainerIntegrationTest {
	
	public OrionBlobContainerIntegrationLiveTest() {
		this.provider = "orionblob";
	}
}
